                    ...
                    static void Main(string[] args)
                    {
                        ...
                        while (c)
                        {
                            ...
                            if (choice == 1)
                            {
                                ...
                                if (op == 1)
                                    hotel.ShowFreeRoom("Suite");
                                if (op == 2)
                                    hotel.ShowFreeRoom("Junior Suite");
                                if (op == 3)
                                    hotel.ShowFreeRoom("Standard");
                                if (op == 4)
                                    hotel.ShowFreeRoom("Moderate");
                                if (op == 5)
                                    hotel.ShowFreeRoom("Superior");
                            }
                            if (choice == 2)
                            {
                                int op = 0;
                                ...
                                if (op == 2)
                                {
                                    ...
                                    hotel.Junior_Suite_roominfo(name, id);
                                }
                                if (op == 3)
                                {
                                    string name;
                                    ...
                                    hotel.StandardRoom_roominfo(name, id);
                                }
                                if (op == 4)
                                {
                                    string name;
                                    ...
                                    Console.WriteLine(" Enter Id ");
                                    id = int.Parse(Console.ReadLine());
                                    hotel.Moderate_roominfo(name, id);
                                }
                                if (op == 5)
                                {
                                    string name;
                                    ...
                                    hotel.Superior_roominfo(name, id);
                                }
                            }
                            if (choice == 3)
                            {
                                ...
                                if (op == 1)
                                {
                                    ...
                                    id = int.Parse(Console.ReadLine());
                                    hotel.Suite_ReservedCustomer(id);
                                }
                                if (op == 2)
                                {
                                    int id;
                                    Console.WriteLine(" Enter FloorNo ");
                                    id = int.Parse(Console.ReadLine());
                                    hotel.Junior_Suite_ReservedCustomer(id);
                                }
                                if (op == 3)
                                {
                                    int id;
                                    ...
                                    hotel.StandardRoom_ReservedCustomer(id);
                                }
                                if (op == 4)
                                {
                                    int id;
                                    ...
                                    hotel.Moderate_ReservedCustomer(id);
                                }
                                ...
                                if (op == 5)
                                {
                                    ...
                                    hotel.Superior_ReservedCustomer(id);
                                }
                            }
